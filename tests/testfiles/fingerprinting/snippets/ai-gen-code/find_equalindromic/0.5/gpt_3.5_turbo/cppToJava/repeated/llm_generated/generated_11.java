...
class Solution {
    public long minimumCost(int[] nums) {
        ...
        StringBuilder sb2 = new StringBuilder(pal_next);
        pal_next = temp + sb2.reverse().toString();
        ...
        StringBuilder sb3 = new StringBuilder(pal_prev);
        pal_prev = temp + sb3.reverse().toString();
